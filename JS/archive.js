 const exhibiList = {
  '2022': [ {
    ...
    title: '제22회이인성미술상 수상자전<br> 《유근택: 대화》',
  ...
  },
  {
    ...
    title: '2022Y 아티스트 프로젝트<br> 《펑키-펑션》',
    period: '2022-11-08~2023-01-15',
    place: '대구미술관4, 5 전시실',
    year:1
  },
  ...
  },
  {
    ...
    title: '2022다티스트<br>《이교준의 라티오(Ratio)》',
  ...
  },
  {
    ...
    title: '2022어미홀 프로젝트 <br>《토끼와 평행정원》',
  ...
  },
  {
    ...
    title: '2022년소장품 기획전 <br>《나를 만나는 계절》',
  ...
  '2021': [ {
    ...
    title: '대구미술관개관 10주년 기념 <br>해외교류전 《모던라이프》',
  ...
  },
  {
    ...
    title: '대구미술관-주캐나다한국문화원교류전<br> 《한국의 근대미술: 대구풍경》',
  ...
  },
  {
    ...
    title: '제21회이인성미술상 수상전<br> 《강요배:카네이션-마음이 몸이 될 때》',
  ...
  },
  {
    ...
    title: '2021Y아티스트프로젝트<br> 《유머랜드주식회사》(Humorland&Co)',
  ...
  },
  {
    ...
    title: '이인성미술상20주년<br> 기념 특별전 (위대한 서사)',
  ...
  '2019': [ {
    ...
    title: '한국-인도교류전_ 3.1운동 100주년 기념전:<br> 1919년 3월 1일 날씨 맑음',
  ...
  },
  {
    ...
    title: '당신속의 마법<br>(You have witchcraft in your lips.)',
  ...
  },
  {
    ...
    title: '2019이인성 특별전 <br><화가의 고향, 대구>',
  ...
  },
  {
    ...
    title: '제19회이인성 미술상 수상자<br> <공성훈 : 사건으로서의 풍경>',
    period: '2019-11-05~2020-01-12',
    place: '2,3전시실, 선큰가든',
    year:2019
  },
  {
    ...
    title: '국립현대미술관순회전<br> <탄생 100주년 기념: 곽인식>',
  ...
  '2018': [ {
    ...
    title: '프레임이후의 프레임:<br> 한국현대사진운동 1988-1999',
  ...
  },
  {
    ...
    title: '2018어미홀 프로젝트<br> <나현, 바벨 - 서로 다른 혀>',
    period: '2018-10-23~2019-01-13',
    place: '어미홀',
    year:2018
  },
 ...
 function init() {
  const accodionMenu = document.querySelector('.four__container .accodion_menu');
  for(let prop in exhibiList) {
    console.log(prop);

    
    const div = document.createElement('div');
    div.innerHTML = `
      <button class="accordion Bebas">${prop}</button>
      <div class="panel"></div>
    `;
    accodionMenu.prepend(div);

    const btn = div.querySelector('button.accordion');
    ...
    const arr = exhibiList[prop];
    const panel = div.querySelector('.panel');
    arr.forEach(item => {
      const archiveItemDiv = document.createElement('div');
      archiveItemDiv.className = 'archive_item';
      archiveItemDiv.innerHTML = `
        <div class="archive_text">
          <div>${item.title}</div>
          <div>${item.period}</div>
          <div>${item.place}</div>
        </div>
        <div class="archive_poster">
          <img src='${item.img}' alt='${item.title}'>
        </div>
      `;
      panel.append(archiveItemDiv);
    });
  }
 }
...
// exhibiList.forEach(function(exhibiList){
//   const ExhibiImag=exhibiList.img;
//   const ExhibiTitle=exhibiList.title;
//   const ExhibiPeriod=exhibiList.period;
//   const ExhibiPlace=exhibiList.place;
//   const ExhibiYear=exhibiList.year;
